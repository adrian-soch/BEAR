...
# ---------------------------------------------------------------------------------------------------------------------------------
# Code from Tiziano Fiorenzani: https://github.com/tizianofiorenzani/ros_tutorials/blob/master/donkey_car/src/low_level_control.py
# ---------------------------------------------------------------------------------------------------------------------------------


# Dependacies: ros-i2cpwmboard package must be installed

# Subscribes: /cmd_vel
# Publishes: i2cpwmboard
...
class DkLowLevelCtrl():
    def __init__(self):
        ...
        self.actuators['steering']  = ServoConvert(id=6, direction=1) #-- positive left
